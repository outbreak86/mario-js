...
setUp();
 function setUp()
 {
   var myButton = document.getElementById("dButton")
   myButton.onclick = function(){determineHeightAndThenDrawPyramid()}
 }
...
function determineHeightAndThenDrawPyramid() {
    ...
    var myField = document.getElementById("height");
    heightStr = myField.value;
 ...
 */
 function drawPyramid(height) {
     ...
     // before drawing, clear the old content
      var pym = document.getElementById("pyramid");
      while (pym.firstChild) {
        pym.removeChild(pym.firstChild);
        }
